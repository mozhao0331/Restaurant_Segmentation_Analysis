...
def create_bar_chart(df, col_name, xlab, title, out_dir):
    ...
    try:
        plt.savefig(img_sub + out_dir + "_bar_plot.png", bbox_inches="tight")
    except:
        os.mkdir(img_sub)
        plt.savefig(img_sub + out_dir + "_bar_plot.png", bbox_inches="tight")
...
def create_stack_bar_chart(df, col_name, title, out_dir):
    ...
    try:
        plt.savefig(img_sub + out_dir + "stacked_bar_plot.png", bbox_inches="tight")
    except:
        os.mkdir(img_sub)
        plt.savefig(img_sub + out_dir + "stacked_bar_plot.png", bbox_inches="tight")
...
def create_boxplot(df, col_name, ylabel, title, out_dir):
    ...
    plt.suptitle("")
    try:
        fig.savefig(img_sub + out_dir + "_boxplot.png", bbox_inches="tight")
    except:
        os.mkdir(img_sub)
        fig.savefig(img_sub + out_dir + "_boxplot.png", bbox_inches="tight")
...
def create_scatterplot(df, x_col, y_col, groupby_col, xlab, ylab, title, out_dir):
    ...
    for category in categories:
        ...
        if col == 2:
            ...
            col = 0
    try:
        fig.savefig(img_sub + out_dir + "_scatterplot.png", bbox_inches="tight")
    except:
        os.mkdir(img_sub)
        fig.savefig(img_sub + out_dir + "_scatterplot.png", bbox_inches="tight")
