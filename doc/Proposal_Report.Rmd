...
```{r out.width = '100%', out.height = '100%', fig.align='center', fig.cap = "The proportion of people who do not default is greater."}
knitr::include_graphics("../img/smoothie_category_bar_plot.png")
```

```{r out.width = '100%', out.height = '100%', fig.align='center', fig.cap = "The highest portion among categories are “Very Large Metro”. “Home” has a high percentage of “Very Large Metro”. “Travel” has a high percentage of “Small City”."}
knitr::include_graphics("../img/market_size_stackstacked_bar_plot.png")
```

```{r out.width = '100%', out.height = '100%', fig.align='center', fig.cap = "Most of the stores are located in “Exurban” and “Light Suburban”."}
knitr::include_graphics("../img/market_size_stackstacked_bar_plot.png")
```

```{r out.width = '100%', out.height = '100%', fig.align='center', fig.cap = "Rural has the highest count."}
knitr::include_graphics("../img/subway_us_store_density_bar_plot.png")
```

```{r out.width = '100%', out.height = '100%', fig.align='center', fig.cap = "Very Large Metro has the highest count with 5190 stores, and other categories have similar counts."}
knitr::include_graphics("../img/subway_us_market_size_bar_plot.png")
```

```{r out.width = '100%', out.height = '100%', fig.align='center', fig.cap = "The most common market size is Very Large Metro with 577 stores."}
knitr::include_graphics("../img/subway_canada_store_density_bar_plot.png")
```

```{r out.width = '100%', out.height = '100%', fig.align='center', fig.cap = "Very Large Metro has the highest count with 577 stores, and the other categories have similar counts."}
...
| Schedule                 |                                        | Objective                                                                                                                                                      |
|--------------------------|----------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Week 1 (5/1 - 5/7)**   | EDA & Proposal                         | Understand the problem, perform initial EDA on the dataset, and propose potential models and approaches to each objective.                                     |
| **Week 2 (5/8 - 5/14)**  | Feature Selection                      | Explore a variety of methods to determine the most important features for each of the three datasets.                                                          |
| **Week 3 (5/15 - 5/21)** | Supervised Model                       | Train and test a supervised classification model on the labeled dataset, as well as a list of the most important features as major indicators.                 |
| **Week 4 (5/22 - 5/28)** | Unsupervised Model (part I)            | Train an unsupervised clustering model on one of the unlabeled datasets and apply several potential evaluation metrics.                                        |
| **Week 5 (5/29 - 6/4)**  | Unsupervised Model (part II)           | Train an unsupervised clustering model on one of the unlabeled datasets and apply several potential evaluation metrics.                                        |
| **Week 6 (6/5 - 6/11)**  | Models Tuning & Parameter Optimization | Perform parameter tuning and optimization on the three models.                                                                                                 |
| **Week 7 (6/12 - 6/18)** | Final Presentation                     | Present the final models as well as the list of important indicators from the list of features. Address potential directions and approaches for further study. |
| **Week 8 (6/19 - 6/28)** | Final Product & Reflection             | Draft submission for the final product and report and iterate on feedback before final submission.                                                             |
