...
knitr::include_graphics("../img/eda/smoothie_category_bar_plot.png")
```
...
knitr::include_graphics("../img/eda/market_size_stackstacked_bar_plot.png")
```

```{r out.width = '80%', fig.align='center', fig.cap = "Most of the stores are located in “Exurban” and “Light Suburban”."}
knitr::include_graphics("../img/eda/store_density_stackstacked_bar_plot.png")
```

```{r out.width = '70%', fig.align='center', fig.cap = "Rural has the highest count."}
knitr::include_graphics("../img/eda/subway_us_store_density_bar_plot.png")
```
...
knitr::include_graphics("../img/eda/subway_us_market_size_bar_plot.png")
```

```{r out.width = '65%', fig.align='center', fig.cap = "The most common market size is Very Large Metro with 577 stores."}
knitr::include_graphics("../img/eda/subway_canada_store_density_bar_plot.png")
```
...
knitr::include_graphics("../img/eda/subway_canada_market_size_bar_plot.png")
```
...
knitr::include_graphics("../img/info/smoothie_flow_chart.png")
```
...
knitr::include_graphics("../img/info/subway_flow_chart.png")
```

## Timeline

```{r out.width = '90%', fig.align='center'}
knitr::include_graphics("../img/info/timeline.png")
```
