...
With each customer's marketing dynamics slightly different, the solution will be tailored to the data gathered around each restaurant franchise. This project will take the exploratory first step in building customized solutions for three customers: Smoothie King US, Subway US and Subway Canada. At the end of the project, we expect to have the following three machine learning pipelines:
...
These machine learning data pipelines are expected to be incorporated into our partner's consulting services for these clients.

The final product will be integrated into a GitHub repository, including the scripts for the machine learning data pipelines, reproducible results and reports, and documentation.
